...
% ****************************************************************************************************
\newcommand{\myTitle}{Dokumentation einer konzeptionellen Ausarbeitung eines Condition Monitoring Systems des Moduls Software-Architektur}
...
\newcommand{\myNameOne}{Alexander Huber\xspace}
\newcommand{\myNameTwo}{Manh-Khang Richard Mai\xspace}
\newcommand{\myNameThree}{Hendrik Haas\xspace}
...
\newcommand{\myTime}{29.~März~2020\xspace}
...
\hypersetup{%
    ...
    pdftitle={\myTitle},%
    pdfauthor={\textcopyright\ \myNameOne, \myNameTwo, \myNameThree, \myUni},%
    pdfsubject={},%
    pdfkeywords={},%
    pdfcreator={pdfLaTeX},%
