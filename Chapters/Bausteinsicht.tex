...
\begin{table}[th]
	\begin{tabularx}{\textwidth}{X X}
		\hline
		RequestHandler & Verarbeitet alle Anfragen und entscheidet, welche Anfrage zu welcher Datenbank weitergeleitet werden muss \\
		\hline
		Filtermodul & Überprüft eigenständig alle Daten in der NoSQL Datenbank auf Korrektheit und bei Auffälligkeiten werden diese in die relationale Datenbank abgelegt\\
		\hline
	\end{tabularx} 
	\caption{Funktionen der Datenbankverwaltung}
